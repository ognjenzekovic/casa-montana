...
export function Book() {
    ...
    return (
        <section id="book" ref={ref} className="book reveal">
            <span className="eyebrow book__eyebrow">Pre kupovine</span>
            <h2 className="book__title">Prenoćite pre nego što odlučite</h2>
            <p className="book__body">
                Casa Montana se aktivno izdaje i nosi ocenu 9.8/10 od gostiju.
                Rezervišite boravak i uverite se lično, pre nego što se odlučite.
            </p>
