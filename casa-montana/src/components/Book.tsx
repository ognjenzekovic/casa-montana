...
export function Book() {
    ...
    return (
        <section id="book" ref={ref} className="book reveal">
            <span className="eyebrow book__eyebrow">{t.book.eyebrow}</span>
            <h2 className="book__title">{t.book.title}</h2>
            <p className="book__body">{t.book.body}</p>
            <div className="book__buttons">
                <a
                    className="book__btn book__btn--booking"
                    href="https://www.booking.com/hotel/rs/casa-montana.sr.html"
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={() => trackOutboundClick('booking')}
                >
                    <svg className="book__btn-icon" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a
                    className="book__btn book__btn--airbnb"
                    href="https://www.airbnb.com/rooms/830956234236950016"
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={() => trackOutboundClick('airbnb')}
                >
                    <svg className="book__btn-icon" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => trackOutboundClick('instagram')}
            >
                <svg className="book__ig-icon" viewBox="0 0 24 24" aria-hidden="true">
